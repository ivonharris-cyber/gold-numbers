...
import type { BirthInfo } from './generator.js';
import { signForDate, luckyDigitsFor } from './zodiac.js';

export interface OracleReading {
  street: string;  // Bangkok street to buy the ticket on
  day: string;     // day of week
  time: string;    // time window, e.g. "09:00-11:00"
}
 ...
 */
export function ticketOracle(birth: BirthInfo): OracleReading {
